...
| Class | 12 |
| NCERT unit | Unit 15 (Class 12) |
| NCERT code | `lech207` |
| NCERT edition | Pre-rationalisation NCERT (2018-19 edition) |
| Needed for | JEE Advanced |
| PDF | [`lech207-legacy.pdf`](lech207-legacy.pdf) |
| Module PDF | _not uploaded yet_ |
| Official URL | no longer published - removed in the 2023 rationalisation, and the code `lech207` no longer exists in the current book |
| Mirror used | `manisoni28/books` -> `books/ta20181001153836925812ChemistryNcertChapter15.pdf` |
