...
- [Redox Reactions (Unit 7)](../07-Redox-Reactions/notes.md) — the E°/ΔG/K triangle, and why 'K large' never means 'fast'.
- [Thermodynamics (Unit 5)](../05-Thermodynamics/README.md) — ΔG, ΔH, ΔS and the derivation behind §9.
- [Electrochemistry (Class XII Unit 2)](../../Class-12/02-Electrochemistry/notes.md) — Nernst, `log K = nE°/0.0591`, Ksp from emf, and the conductometric evidence behind weak electrolytes (§15).
- [Solutions (Class XII Unit 1)](../../Class-12/01-Solutions/README.md) — Henry's law and Raoult's law as the physical-equilibrium cases of §3.
