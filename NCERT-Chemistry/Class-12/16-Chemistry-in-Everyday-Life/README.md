...
| PDF | [`lech208-legacy.pdf`](lech208-legacy.pdf) |
| Official URL | no longer published - removed in the 2023 rationalisation, and the code `lech208` no longer exists in the current book |
| Mirror used | `manisoni28/books` -> `books/ta20181001153836929512ChemistryNcertChapter16.pdf` |
