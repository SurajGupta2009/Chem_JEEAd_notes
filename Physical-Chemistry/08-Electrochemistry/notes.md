...
chapter and it is the link to [Equilibrium §9](../04-Equilibrium/notes.md).
...
*Cross-links:* [Redox Reactions (Class XI Unit 7)](../05-Redox-Reactions/notes.md) — O.S. bookkeeping,
...
*Equilibrium (Class XI Unit 6)* — [Part A/B for `ΔG = −RT lnK`, Q vs K and why a "dead" cell is an equilibrated one](../04-Equilibrium/notes.md); [Part C for Kw, Ka and buffers, which the conductance and pH arguments in §10 and §18 rely on](../04-Equilibrium/notes.md).
