...
| Class | 11 |
| NCERT unit | Unit 10 (Class 11) |
| NCERT code | `kech105` |
| NCERT edition | Pre-rationalisation NCERT (2018-19 edition) |
| Needed for | JEE Advanced |
| PDF | [`kech105-legacy.pdf`](kech105-legacy.pdf) |
| Module PDF | _not uploaded yet_ |
| Official URL | no longer published - removed in the 2023 rationalisation. `kech105.pdf` on ncert.nic.in is now *Thermodynamics*, not this chapter |
| Mirror used | `palhiman/ncert` -> `XI/Chemistry-1/kech105.pdf` |
